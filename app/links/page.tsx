...
export const metadata = { title: 'Date nights, home & travel | Cella Channel', robots: { index: false, follow: false } }
export default function LinksPage() {
  return <ChannelShell><div className="max-w-2xl py-12 sm:py-20"><p className="mb-5 tracking-[.2em] text-purple-300">CELLA CHANNEL</p><h1 className="text-6xl leading-tight sm:text-8xl">Good nights.<br/>Great trips.</h1><p className="mt-6 text-xl text-white/75">Date nights in and out, what I’d order and travel stories from my own trips.</p></div>
    <div className="grid gap-5 sm:grid-cols-2">
      <MeasuredLink event="home_story_open" placement="link_hub" href="/home/wine-bar-at-home" className="rounded-2xl border border-purple-300/60 p-8 transition hover:bg-white/10 focus-visible:outline-4 focus-visible:outline-purple-300 sm:col-span-2"><span className="text-sm tracking-widest">AT HOME</span><h2 className="my-4 text-4xl">The bottle-candle video</h2><p className="text-xl">My Kmart candle source, alternatives and empty bottles. →</p></MeasuredLink>
